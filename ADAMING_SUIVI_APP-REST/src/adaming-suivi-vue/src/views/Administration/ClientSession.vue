...
<div class="card"  :style="{'direction' : rtl}" >
  ...
  Client Session
    <span :style="{'float' : float}" ><b-button  @click="modalAjout()" variant="info">Ajouter</b-button> </span>
...
<!-- Partie Ajout --> 
  ...
  <div :style="{'direction' : rtl}">
    <b-form class="p-2">
          <b-form-group >
            <label>libelle</label>
            <b-form-input   type="text"  v-model="client.libelle"></b-form-input>
          </b-form-group>
          ...
          <b-row>
           ...
           <b-row>
                ...
                <b-col sm="6">
                    ...
                    <b-button variant="success"  @click="addclient()"> Ajouter </b-button>                  
                </b-col>
           </b-row>            
    </b-form>
...
<script>
 ...
 import ClientService from '@/services/administrationService/ClientService'
...
export default {
  ...
  methods: {
    ...
    ClientService.getClients().then(function(response) {
      ...
      addclient() {
      var vm = this;
      ClientService.addClients(vm.client)
        .then(response => {         
  ...
  updatecontact(competence) {
      var vm = this;
      CompetenceService.updateCompetences(competence).then(response => {
        vm.getCompetences();
    ...
    modalUpdate(competence){
      var vm = this;
      vm.errors.clear()
      vm.competence=Object.assign({}, vm.competence,  competence)

        ...
        },
         {
          ...
          styleClass="vgt-table  bordered vgt-center-align">
            ...
            <template slot="table-row" slot-scope="props" >
              <span v-if="props.column.field  == 'login'">
               {{props.row.login}}
              </span>
               <span v-if="props.column.field  == 'profil'">
               {{props.row.profil}}
              </span>
               <span v-if="props.column.field  == 'actif'">
               {{props.row.actif}}
              </span>
               <span v-if="props.column.field  == 'reporting'">
               {{props.row.reporting}}
              </span>
...
<script>
 ...
 import UtilisateurService from '@/services/administrationService/UtilisateurService'
...
export default {
  ...
  methods: {
    getLieux(){
        var vm = this;
    UtilisateurService.getAllUtilisateurs().then(function(response) {

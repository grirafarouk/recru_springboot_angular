...
public class OAuthSwaggerSecurityConfig {
	...
	private static final String CLIENT_ID = "adamingsuiviangular";
	...
	public SecurityScheme securityScheme() {
		...
		SecurityScheme oauth = new OAuthBuilder().name(SECURITY_SCHEME_NAME).grantTypes(Lists.newArrayList(grantType))
				.scopes(Lists.newArrayList(scopes())).build();

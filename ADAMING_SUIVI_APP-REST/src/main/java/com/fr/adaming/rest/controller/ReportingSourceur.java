...
@RestController
@RequestMapping(value = "/ReportingSourceur")
@CrossOrigin("*")
public class ReportingSourceur {
	...
	public List<ReportingSourceurParDispoDto> RechercheReportingSourceur(@RequestBody ReportingListSourceurDto utilisateur, Date dateDebut,
			Date dateFin) {
	...
	public HashMap<String, Integer> RechercheReportingCVParTechnologieParSourceur(@RequestBody ReportingListSourceurDto utilisateur, Date dateDebut,
			Date dateFin) {
		HashMap<String, Integer> map = new HashMap<String, Integer>();

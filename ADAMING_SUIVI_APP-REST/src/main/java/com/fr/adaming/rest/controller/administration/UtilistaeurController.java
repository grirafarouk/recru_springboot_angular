...
public class UtilistaeurController {
	...
	public List<Utilisateur> rechercherUtilisateur(@PathVariable String text) {
		return utilisateurService.rechercheUser(text);
	}
	public Utilisateur merge(Utilisateur entity) {
		return utilisateurService.merge(entity);
	}
	
	@PostMapping("/listeusers")
	public List<Utilisateur> rechercherListeUtilisateurs(@RequestBody Utilisateur utilisateur){
		  return utilisateurService.rechercheListeutilisateurs(utilisateur);
	}

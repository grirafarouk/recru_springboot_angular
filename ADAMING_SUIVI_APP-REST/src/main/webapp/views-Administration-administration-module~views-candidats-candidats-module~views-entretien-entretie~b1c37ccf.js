...
var CustomTableComponent = /** @class */ (function () {
    ...
    CustomTableComponent.prototype.doRechercheCandidat = function (callBack) {
        ...
        if (this.item == null)
            this.item = {};
        this.parent.recherche(this.item, page, this.size).subscribe(function (data) {

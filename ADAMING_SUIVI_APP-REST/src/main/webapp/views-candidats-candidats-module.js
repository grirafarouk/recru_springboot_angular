...
var ExcelService = /** @class */ (function () {
    ...
    ExcelService.prototype.exportAsExcelFile = function (json, excelFileName, columns) {
        var cleanData = [];
        var cleanCol = {};
        var col = [];
            ...
            columns.forEach(function (col) {
                if (element[col.data] != null) {
                    if (col.dateFormat != undefined)
                        cleanItem[col.title] = moment__WEBPACK_IMPORTED_MODULE_4__(element[col.data]).format(_helper_application_constant__WEBPACK_IMPORTED_MODULE_3__["DATE_FORMAT_MOMENT"]);
                        ...
                        cleanItem[col.title] = element[col.data];
                    if (cleanCol[col.data] == null)
                        cleanCol[col.data] = col.title.length;
        ...
        Object.keys(cleanCol).forEach(function (element) {
            col.push({ wch: cleanCol[element] + 1 });
        });
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_2__["utils"].json_to_sheet(cleanData);
        worksheet["!cols"] = col;
        var workbook = { Sheets: { 'data': worksheet }, SheetNames: ['data'] };
        var excelBuffer = xlsx__WEBPACK_IMPORTED_MODULE_2__["write"](workbook, { bookType: 'xlsx', type: 'array', cellDates: true, cellStyles: true });
...
var CandidatsComponent = /** @class */ (function () {
    ...
    CandidatsComponent.prototype.recherchecandidate = function () {
        ...
        if (this.candidate.nom == "" || this.candidate.prenom == "" || this.candidate.nom == undefined || this.candidate.prenom == undefined) {
            ...
            this.candidatsService.rechercheAjoutNouveauxcandidats(candidateTemp, 0, 0).subscribe(function (data) {
        ...
        if (value != "")
            this.codePostalService.completeCodePostal(value).subscribe(function (data) {
                data.forEach(function (element) {
                    _this.codePostals = [element].concat(_this.codePostals);
                });
            });
        else
            this.codePostals = [];
    ...
    CandidatsComponent.prototype.saveCandidat = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var validEmailRegEx, error, cand_1, cand_2, cand_3, cand_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.candidate.email == "" || this.candidate.email == undefined || !validEmailRegEx.test(this.candidate.email))) return [3 /*break*/, 1];
                        this.notifierService.notify("error", " Écrivez un email valide");
                        error = true;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.candidatsService.getCandidatByEmail(this.candidate.email).toPromise().then(function (data) {
                            cand_1 = data;
                        })];
                    case 2:
                        _a.sent();
...
var FicheCandidatComponent = /** @class */ (function () {
    function FicheCandidatComponent(route, competencesService, codePostalService, originesService, technologiesService, candidatsService, sanitizer, router, lieuxService, notifierService, motifService, routingState, entretienService, userService, helperService) {
        ...
        this.mask = _helper_application_constant__WEBPACK_IMPORTED_MODULE_19__["PHONE_MASK"];
    ...
    FicheCandidatComponent.prototype.ngOnInit = function () {
        ...
        this.route.data
            ...
            if (_this.currentCandidat.entretien != undefined && _this.currentCandidat.entretien != null && _this.currentCandidat.entretien.date != null)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.currentCandidat.motif = null;
                        return [4 /*yield*/, this.candidatsService.updateficheCandidat(this.currentCandidat).toPromise().then(function (data) {
                                if (_this.callback != null)
                                    _this.callback(data.id);
                            })
                            //#endregion
                        ];
                    case 2:
    ...
    FicheCandidatComponent.prototype.envoiMailHorCibleFunction = function () {
        ...
        if (this.currentCandidat.motif != undefined && this.currentCandidat.motif != undefined && this.commentaireMotif != "") {
            this.candidatsService.envoyerEmailHorsCibleCandidats(this.currentCandidat, this.userService.getConnetedUserInfo().login, this.commentaireMotif).subscribe(function (data) {
                _this.notifierService.notify("success", "Mail envoyé avec succès");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sauvgarderFiche()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
/* harmony import */ var _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../services/utilisateur.service */ "./src/app/services/utilisateur.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var listeCandidatArelancerComponent = /** @class */ (function () {
    function listeCandidatArelancerComponent(router, candidatsService, helperService, notifierService, technologiesService, routingState, regionService, utilisateurService) {
        var _this = this;
        this.router = router;
        this.candidatsService = candidatsService;
        this.helperService = helperService;
        ...
        this.columns = [
            ...
            },
            {
                ...
                visible: false,
                dateFormat: _helper_application_constant__WEBPACK_IMPORTED_MODULE_8__["DATE_FORMAT"]
            },
            {
                data: 'technologie',
        ...
        this.mask = _helper_application_constant__WEBPACK_IMPORTED_MODULE_8__["PHONE_MASK"];
    }
    listeCandidatArelancerComponent.prototype.ngOnInit = function () {
        ...
        this.utilisateurService.getAllSourceurs().subscribe(function (data) {
            _this.listSourceur = data;
        });
        this.utilisateurService.getAllChages().subscribe(function (data) {
            _this.listCarge = data;
        });
    };
    ...
    listeCandidatArelancerComponent.prototype.recherche = function (item, page, size, allValue) {
        return this.candidatsService.rechercheCandidatArelancer(item, page, size);
    };
    listeCandidatArelancerComponent.prototype.rechercheNbr = function (item, allValue) {
    ...
    listeCandidatArelancerComponent.prototype.relanceHandleChange = function (event) {
    ...
    listeCandidatArelancerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"],
            ...
            _services_administrationService_region_service__WEBPACK_IMPORTED_MODULE_7__["RegionService"], _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_10__["UtilisateurService"]])
...
/* harmony import */ var _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/utilisateur.service */ "./src/app/services/utilisateur.service.ts");
/* harmony import */ var _services_administrationService_region_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../services/administrationService/region.service */ "./src/app/services/administrationService/region.service.ts");
/* harmony import */ var _services_excel_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../services/excel.service */ "./src/app/services/excel.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var listeNouveauxCandidatsComponent = /** @class */ (function () {
    function listeNouveauxCandidatsComponent(router, technologiesService, candidatsService, helperService, routingState, notifierService, utilisateurService, regionService, excelService) {
        var _this = this;
        this.router = router;
        this.technologiesService = technologiesService;
        this.candidatsService = candidatsService;
    ...
    listeNouveauxCandidatsComponent.prototype.recherche = function (item, page, size, allValue) {
        return this.candidatsService.rechercheNouveauxcandidats(item, page, size);
    };
    listeNouveauxCandidatsComponent.prototype.rechercheNbr = function (item, allValue) {
    ...
    listeNouveauxCandidatsComponent.prototype.exportAsXLSX = function () {
        var _this = this;
        this.candidatsService.rechercheNouveauxcandidats(this.table.item, 0, this.table.maxlenght).subscribe(function (data) {
            _this.excelService.exportAsExcelFile(data, _this.titleTable, _this.columns);
        });
    };
    listeNouveauxCandidatsComponent.prototype.codePostaleOnSearch = function (value) {
        var _this = this;
        if (value != "")
            this.regionService.completeRegion(value).subscribe(function (data) {
                data.forEach(function (element) {
    ...
    listeNouveauxCandidatsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"],
            ...
            angular_notifier__WEBPACK_IMPORTED_MODULE_3__["NotifierService"],
            _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_9__["UtilisateurService"],
            _services_administrationService_region_service__WEBPACK_IMPORTED_MODULE_10__["RegionService"],
            _services_excel_service__WEBPACK_IMPORTED_MODULE_11__["ExcelService"]])
...
/* harmony import */ var _helper_routing_state_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../helper/routing-state.service */ "./src/app/helper/routing-state.service.ts");
/* harmony import */ var _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../services/utilisateur.service */ "./src/app/services/utilisateur.service.ts");
/* harmony import */ var _services_excel_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../services/excel.service */ "./src/app/services/excel.service.ts");
...
var listeTousCandidatsComponent = /** @class */ (function () {
    function listeTousCandidatsComponent(router, candidatsService, routingState, notifierService, technologiesService, lieuxService, helperService, regionService, utilisateurService, excelService) {
        var _this = this;
        this.router = router;
        this.candidatsService = candidatsService;
        this.routingState = routingState;
            ...
            },
            {
                ...
                rendered: function (e) {
                    return e.dateEntretien != null && e.dateInscription != null
                        ? Math.ceil((new Date(moment__WEBPACK_IMPORTED_MODULE_15__(e.dateEntretien).format("MM/DD/YYYY")).getTime() - new Date(moment__WEBPACK_IMPORTED_MODULE_15__(e.dateInscription).format("MM/DD/YYYY")).getTime()) / (1000 * 3600 * 24)) + " (J)" : " - ";
                }
            },
            {
                data: 'statut',
        ...
        this.technologies = [];
        this.lieux = [];
        this.mask = _helper_application_constant__WEBPACK_IMPORTED_MODULE_9__["PHONE_MASK"];
        this.region = [];
    ...
    listeTousCandidatsComponent.prototype.recherche = function (item, page, size, allValue) {
        return this.candidatsService.rechercheTouscandidats(item, page, size);
    };
    listeTousCandidatsComponent.prototype.rechercheNbr = function (item, allValue) {
    ...
    listeTousCandidatsComponent.prototype.exportAsXLSX = function () {
        var _this = this;
        this.candidatsService.rechercheTouscandidats(this.table.item, 0, this.table.maxlenght).subscribe(function (data) {
            _this.excelService.exportAsExcelFile(data, _this.titleTable, _this.columns);
        });
    };
    __decorate([
    ...
    listeTousCandidatsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services_candidats_service__WEBPACK_IMPORTED_MODULE_2__["CandidatsService"], _helper_routing_state_service__WEBPACK_IMPORTED_MODULE_12__["RoutingState"],
            ...
            _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_13__["UtilisateurService"],
            _services_excel_service__WEBPACK_IMPORTED_MODULE_14__["ExcelService"]])

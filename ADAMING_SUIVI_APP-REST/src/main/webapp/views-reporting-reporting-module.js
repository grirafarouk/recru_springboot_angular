...
var ReportingSourceurService = /** @class */ (function () {
    ...
    ReportingSourceurService.prototype.rechercheReportingSourceur = function (sourceur, dateDebut, datFin) {
        ...
        return this.httpClient.post(_helper_application_constant__WEBPACK_IMPORTED_MODULE_2__["BACK_END_URL"] + url, sourceur, httpOptions);
    };
...
/* harmony import */ var _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../services/utilisateur.service */ "./src/app/services/utilisateur.service.ts");
...
var ListeReportingComponent = /** @class */ (function () {
    function ListeReportingComponent(originesService, technologiesService, sanitizer, candidatsService, notifierService, competencesService, helperService, regionService, lieuxService, router, utilisateurService) {
        var _this = this;
    ...
    ListeReportingComponent.prototype.recherche = function (item, page, size, allValue) {
        return this.candidatsService.rechercheReporting(item, page, size);
    };
    ListeReportingComponent.prototype.rechercheNbr = function (item, allValue) {
    ...
    ListeReportingComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_13__["utils"].json_to_sheet(json);
        var cell = worksheet["A1"];
        cell.s = { alignment: { textRotation: 90 }, font: { sz: 14, bold: true, color: "#FF00FF" } };
        var workbook = { Sheets: { 'data': worksheet }, SheetNames: ['data'] };
        var excelBuffer = xlsx__WEBPACK_IMPORTED_MODULE_13__["write"](workbook, { bookType: 'xlsx', type: 'array' });
        this.saveAsExcelFile(excelBuffer, excelFileName);
    };
    ListeReportingComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], {
            type: EXCEL_TYPE
        });
        file_saver__WEBPACK_IMPORTED_MODULE_14__["saveAs"](data, this.titleTable);
    };
    ListeReportingComponent.prototype.exportAsXLSX = function () {
        var _this = this;
        this.candidatsService.rechercheReporting(this.table.item, 0, this.table.maxlenght).subscribe(function (data) {
            var cleanData = [];
            data.forEach(function (element) {
                var cleanItem = {};
                _this.columns.forEach(function (col) {
                    if (element[col.data] != null) {
                        if (col.dateFormat != undefined)
                            cleanItem[col.title] = moment__WEBPACK_IMPORTED_MODULE_16__(element[col.data]).format(_helper_application_constant__WEBPACK_IMPORTED_MODULE_12__["DATE_FORMAT_MOMENT"]);
            ...
            _this.exportAsExcelFile(cleanData, 'sample');
        });
    };
    __decorate([
    ...
    ListeReportingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_administrationService_origines_service__WEBPACK_IMPORTED_MODULE_4__["OriginesService"], _services_administrationService_TechnologieService__WEBPACK_IMPORTED_MODULE_6__["TechnologieService"],
            ...
            _services_administrationService_Lieux_service___WEBPACK_IMPORTED_MODULE_9__["LieuxService"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["Router"], _services_utilisateur_service__WEBPACK_IMPORTED_MODULE_15__["UtilisateurService"]])
...
var ReportingSourceurComponent = /** @class */ (function () {
    function ReportingSourceurComponent(sanitizer, reportingSourceur, notifierService) {
        ...
        this.ChartColors = _helper_application_constant__WEBPACK_IMPORTED_MODULE_5__["ChartColors"];
        this.autresCv = null;
        this.totalCVDisponible = null;
        this.totalCVhorsCible = null;
        this.pieChart2Data = [];
        this.pieChart2Labels = ["Autres", "CV disponibles", "CV hors cible"];
        this.Chart2Colors = _helper_application_constant__WEBPACK_IMPORTED_MODULE_5__["ChartColors"];

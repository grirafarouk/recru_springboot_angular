...
function write_sty_xml(wb, opts) {
	return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac" xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" mc:Ignorable="x14ac"><numFmts count="0"/><fonts count="3" x14ac:knownFonts="1"><font><sz val="12"/><name val="Calibri"/></font><font><sz val="12"/><name val="Calibri"/></font><font><sz val="12"/><name val="Calibri"/><color rgb="FF0000"/><b/></font></fonts><fills count="2"><fill><patternFill patternType="none"><bgColor/></patternFill></fill><fill><patternFill patternType="gray125"><bgColor/></patternFill></fill></fills><borders count="2"><border><left/><right/><top/><bottom/><diagonal/></border><border><left/><right/><top/><bottom/><diagonal/></border></borders><cellStyleXfs><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="4"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"  xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="true"/></xf><xf numFmtId="0" fontId="2" fillId="0" borderId="0" xfId="0" applyFont="1" applyAlignment="1"  ><alignment horizontal="center" vertical="center" wrapText="true"/></xf><xf numFmtId="0" fontId="1" fillId="1" borderId="1" xfId="0" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/></cellXfs><cellStyles><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles><dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleMedium4"/></styleSheet>';
}
...
function sheet_add_json(_ws, js, opts) {
	...
	if(offset) for(C = 0; C < hdr.length; ++C) ws[encode_col(C + _C) + __R] = {t:'s', v:hdr[C],z:"1"};
	ws['!ref'] = encode_range(range);
	return ws;
}

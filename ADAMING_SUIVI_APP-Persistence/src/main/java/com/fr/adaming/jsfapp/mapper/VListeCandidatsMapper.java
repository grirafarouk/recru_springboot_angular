...
public interface VListeCandidatsMapper {
	...
	List<VListeCandidatsDto> vListeCandidatsToVListeCandidatsDtos(List<VListeCandidats> v_ListeCandidats);

	List<VListeCandidats> vListeCandidatsDtoToVListeCandidats(List<VListeCandidatsDto> v_ListeCandidatsDto);
	...
	VListeCandidatsDto vListeCandidatsToVListeCandidatsDto(VListeCandidats v_ListeCandidats);
	...
	@Mappings({ @Mapping(source = "id", target = "id"), @Mapping(source = "nom", target = "nom"),
			...
			@Mapping(source = "prenomCharge", target = "prenomCharge"),
			@Mapping(source = "commentaire", target = "commentaire") })
	VListeCandidats VListeCandidatsDtoToVListeCandidats(VListeCandidatsDto v_ListeCandidatsDto);

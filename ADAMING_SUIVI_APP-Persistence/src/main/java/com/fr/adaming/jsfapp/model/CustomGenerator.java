...
//		
//	}
//add the first valuemany variable include the systeme to configure the many of value that can use ftuuiin famanya domaien de=to undersatafnd tting gajgjfhqjghzuk
//
//}
